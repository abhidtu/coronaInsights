...
public class Indexes {
    ...
    private static class Indexes0 {
        ...
        public static Index STATE_CODE_NAME_MAPPING_PRIMARY = Internal.createIndex("PRIMARY", StateCodeNameMapping.STATE_CODE_NAME_MAPPING, new OrderField[] { StateCodeNameMapping.STATE_CODE_NAME_MAPPING.STATE }, true);
